...
import { PlannrdEntity } from "../entity/planned.lookup.entity";
import { RatingEntity } from "../entity/rating.lookup.entity";
import { BySeed, ForSeed, TransactionTypeSeed, PlannrdSeed, RatingSeed, Category1Seed, Category2Seed } from "../entity/seed";
import { TransactionTypeEntity } from "../entity/transaction_type.lookup.entity";
import {getRepository, MigrationInterface, QueryRunner} from "typeorm";

export class createInitialSchema1657593890550 implements MigrationInterface {
    name = 'createInitialSchema1657593890550'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMIT`);
        await getRepository(PlannrdEntity).save(PlannrdSeed);
        await queryRunner.query(`COMMIT`);
