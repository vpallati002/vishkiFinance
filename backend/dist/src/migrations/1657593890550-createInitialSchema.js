...
exports.createInitialSchema1657593890550 = void 0;
...
class createInitialSchema1657593890550 {
    constructor() {
        this.name = 'createInitialSchema1657593890550';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "vishkifinance"."financial_log" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "isActive" boolean NOT NULL, "created" TIMESTAMP WITH TIME ZONE NOT NULL, "ammount" double precision NOT NULL, "review" character varying NOT NULL, "byId" integer, "forId" integer, "transactionTypeId" integer, "category1Id" integer, "category2Id" integer, "category3Id" integer, "plannedId" integer, "ratingId" integer, CONSTRAINT "PK_d337d0712bdb2cf8726a7047cfa" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`COMMIT`);
        await (0, typeorm_1.getRepository)(planned_lookup_entity_1.PlannrdEntity).save(seed_1.PlannrdSeed);
        await queryRunner.query(`COMMIT`);
...
exports.createInitialSchema1657593890550 = createInitialSchema1657593890550;
//# sourceMappingURL=1657593890550-createInitialSchema.js.map