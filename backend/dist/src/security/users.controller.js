...
const lookup_service_1 = require("../shared/lookup/lookup.service");
const transaction_1 = require("./models/transaction");
const users_service_1 = require("./users.service");
let UsersController = class UsersController {
    constructor(userService, lookupService) {
...
], UsersController.prototype, "checkDuplicateEmail", null);
__decorate([
...
__decorate([
    (0, common_1.Post)('addLookup'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "addLookup", null);
